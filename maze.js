(() => {
    ...
    // Labirinto mais complexo: várias paredes verticais e horizontais formando corredores e diversas curvas.
    // O caminho para chegar até o objetivo está garantido, porém exige curvas e movimentos precisos.
  
    const walls = [
      // Paredes externas
      { x: 0, y: 0, w: width, h: WALL_THICKNESS }, // topo
      { x: 0, y: height - WALL_THICKNESS, w: width, h: WALL_THICKNESS }, // base
      { x: 0, y: 0, w: WALL_THICKNESS, h: height }, // esquerda
